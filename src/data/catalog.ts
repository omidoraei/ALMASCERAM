...
export const products: Product[] = [
  {
    ...
    applications: ['کف', 'دیوار', 'فضای تجاری'], image: '/images/tile-arena.jpg', tone: '#c8bba5', badge: 'جدید', sizes: [size120, size80, size60],
  ...
  },
  {
    ...
    applications: ['کف', 'دیوار', 'فضای بیرونی'], image: '/images/tile-concrete.jpg', tone: '#8d8c88', sizes: [size120, size100, size60],
  ...
  },
  {
    ...
    applications: ['دیوار', 'کف', 'فضای لوکس'], image: '/images/tile-calacatta.jpg', tone: '#dedbd3', badge: 'پرفروش', sizes: [size120, size80],
  ...
  },
  {
    ...
    applications: ['نما', 'دیوار', 'فضای تجاری'], image: '/images/tile-noir.jpg', tone: '#343432', sizes: [size80, size60, size100],
  ...
  },
  {
    ...
    applications: ['کف', 'دیوار', 'نما'], image: '/images/tile-arena.jpg', tone: '#cfc1ab', sizes: [size120, size80, size60],
  ...
  },
  {
    ...
    applications: ['کف', 'فضای اداری', 'فضای بیرونی'], image: '/images/tile-concrete.jpg', tone: '#aaa9a5', sizes: [size100, size60],
